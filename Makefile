unit:
	nim c -o:test_result/hex_converter_test -r test/converters/hex_converter_test.nim
	nim c -o:test_result/rgb_converter_test -r test/converters/rgb_converter_test.nim
