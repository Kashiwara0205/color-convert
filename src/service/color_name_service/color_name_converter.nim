...
proc toHsl*(converterObj: ColorNameConverter): HslColor = 
  case converterObj.color.getColorName:
  of RED: return createRgbColorConverter(createRgb(RED_RGB[0], RED_RGB[1], RED_RGB[2])).toHsl
  of GREEN: return createRgbColorConverter(createRgb(GREEN_RGB[0], GREEN_RGB[1], GREEN_RGB[2])).toHsl
  of BLUE: return createRgbColorConverter(createRgb(BLUE_RGB[0], BLUE_RGB[1], BLUE_RGB[2])).toHsl
  of YELLOW: return createRgbColorConverter(createRgb(YELLOW_RGB[0], YELLOW_RGB[1], YELLOW_RGB[2])).toHsl
  of BLACK: return createRgbColorConverter(createRgb(BLACK_RGB[0], BLACK_RGB[1], BLACK_RGB[2])).toHsl
  of WHITE: return createRgbColorConverter(createRgb(WHITE_RGB[0], WHITE_RGB[1], WHITE_RGB[2])).toHsl